...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeDestroy: function beforeDestroy() {//this.$errors.clear()
  }
});
  ...
  return _vm.entity
    ? _c(
        ...
        [
                  ...
                  [
                    ...
                    _vm.entity.id
                      ? _c(
                          "v-action",
                          {
                            staticClass: "btn-lg btn-red",
                            attrs: { type: "button", dusk: "action-destroy" },
                            on: {
                              click: function($event) {
                                _vm.destroying = _vm.entity
                              }
                            }
                          },
                          [
          ...
          _vm._v(" "),
          _c("v-modal", {
            attrs: { dusk: "modal-token" },
            on: {
              closed: function($event) {
                _vm.$router.push(
                  _vm.$link("tokens.index").withQuery({ page: 1 })
                )
              }
            },
            scopedSlots: _vm._u(
              ...
              return _vm._l(entries, function(entry) {
                return _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "card-content hidden sm:block" }, [
...
//# sourceMappingURL=tokens.js.map?id=0d61fdef50d184aab10a