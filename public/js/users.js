                ...
                _c(
                  ...
                  [
                      ...
                      "v-action",
                      {
                        on: {
                          click: function($event) {
                            return _vm.entity.attachments.push({})
                          }
                        }
                      },
                      [_vm._v("Add")]
                    ...
                    _c(
                      ...
                      _vm._l(_vm.entity.attachments, function(
                        attachment,
                        index
                      ) {
                        return _c(
                            ...
                            _c("v-input-file", {
                              ...
                              on: {
                                ...
                                destroyed: function($event) {
                                  return _vm.entity.attachments.splice(index, 1)
                                }
                              },
                              model: {
                                value: _vm.entity.attachments[index],
                                callback: function($$v) {
                                  _vm.$set(_vm.entity.attachments, index, $$v)
                                },
                                expression: "entity.attachments[index]"
                              }
                            })
                          ],
                          1
                    ...
                    _vm.entity.id
                      ? [
                          _c(
                            "v-action",
                            {
                              ...
                              attrs: {
                                dusk: "action-update",
                                loading: _vm.isLoading("users.update")
                              },
                              on: {
                                click: function($event) {
                          ...
                          _c(
                            "v-action",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.update(_vm.entity, false)
                                }
                              }
                            },
                            [
                      ...
                      : _c(
                          "v-action",
                          {
                            ...
                            attrs: {
                              dusk: "action-save",
                              loading: _vm.isLoading("users.store")
                            },
                            on: {
                              click: function($event) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("v-resource", {
        attrs: { loading: _vm.isLoading("users.index"), searchable: true },
        scopedSlots: _vm._u([
          {
            key: "title",
            fn: function() {
